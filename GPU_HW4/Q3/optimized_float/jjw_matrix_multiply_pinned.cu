/*
* CUDA Problem-double (Multiple Matrix - Pinned Memory)
*/
...
int main(int argc, char **argv) {  
  ...
  cudaMallocHost(&hostA, bytesA);
  cudaMallocHost(&hostB, bytesB);
  cudaMallocHost(&hostC, bytesC);
