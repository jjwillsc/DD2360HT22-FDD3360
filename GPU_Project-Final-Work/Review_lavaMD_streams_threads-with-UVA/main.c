		...
		char *argv [])
{
	...
	cudaMallocHost((box_str**)&box_cpu, dim_cpu.box_mem);
	cudaMallocHost((FOUR_VECTOR**)&rv_cpu, dim_cpu.space_mem);
	...
	// printf("%15.12f s, %15.12f % : VARIABLES\n",						(float) (time1-time0) / TIME_DIVIDER, (float) (time1-time0) / (float) (time7-time0) * 100);
	// printf("%15.12f s, %15.12f % : INPUT ARGUMENTS\n", 					(float) (time2-time1) / TIME_DIVIDER, (float) (time2-time1) / (float) (time7-time0) * 100);
	// printf("%15.12f s, %15.12f % : INPUTS\n",							(float) (time3-time2) / TIME_DIVIDER, (float) (time3-time2) / (float) (time7-time0) * 100);
	// printf("%15.12f s, %15.12f % : dim_cpu\n", 							(float) (time4-time3) / TIME_DIVIDER, (float) (time4-time3) / (float) (time7-time0) * 100);
	// printf("%15.12f s, %15.12f % : SYS MEM: ALO\n",						(float) (time5-time4) / TIME_DIVIDER, (float) (time5-time4) / (float) (time7-time0) * 100);

	// printf("%15.12f s, %15.12f % : KERNEL: COMPUTE\n",					(float) (time6-time5) / TIME_DIVIDER, (float) (time6-time5) / (float) (time7-time0) * 100);

	// printf("%15.12f s, %15.12f % : SYS MEM: FRE\n", 					(float) (time7-time6) / TIME_DIVIDER, (float) (time7-time6) / (float) (time7-time0) * 100);

	// printf("Total time:\n");
	// printf("%.12f s\n", 												(float) (time7-time0) / TIME_DIVIDER);
